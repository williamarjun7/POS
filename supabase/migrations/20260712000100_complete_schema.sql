...
-- ─── 16. Suppliers ────────────────────────────────────────────────────────
-- Defined BEFORE inventory_items (which references suppliers)
...
CREATE POLICY "auth_select" ON public.restaurant_tables FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.menu_categories FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.menu_items FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.customers FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.room_types FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.rooms FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.bookings FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.suppliers FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.inventory_items FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.print_settings FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.business_settings FOR SELECT TO authenticated USING (true);
CREATE POLICY "auth_select" ON public.feature_flags FOR SELECT TO authenticated USING (true);

-- ─── Full CRUD for authenticated users on operational tables ──────────────

CREATE POLICY "auth_all" ON public.customers FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.order_batches FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.order_batch_items FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "auth_all" ON public.cash_reconciliations FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.suppliers FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.inventory_items FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "auth_all" ON public.purchase_order_items FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.supplier_payments FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.bookings FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.rooms FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.branches FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.restaurant_tables FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "auth_all" ON public.feature_flags FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.housekeeping_tasks FOR ALL TO authenticated USING (true) WITH CHECK (true);
CREATE POLICY "auth_all" ON public.maintenance_requests FOR ALL TO authenticated USING (true) WITH CHECK (true);
...
CREATE POLICY "act_log_insert" ON public.activity_logs FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "act_log_select" ON public.activity_logs FOR SELECT TO authenticated USING (true);

-- Settings (insert for initial setup, update for authenticated)
CREATE POLICY "settings_insert" ON public.print_settings FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "settings_update" ON public.print_settings FOR UPDATE TO authenticated USING (true);
CREATE POLICY "settings_insert" ON public.business_settings FOR INSERT TO authenticated WITH CHECK (true);
CREATE POLICY "settings_update" ON public.business_settings FOR UPDATE TO authenticated USING (true);
